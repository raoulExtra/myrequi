#!/usr/bin/env python3
"""Compatibility wrapper for prj/continuity_db/imple/V00.00.01/core/memory_command.py."""
...
_CORE_FILE = _CORE_DIR / "memory_command.py"
if str(_CORE_DIR) not in sys.path:
    sys.path.insert(0, str(_CORE_DIR))
_spec = importlib.util.spec_from_file_location("_continuity_core_memory_command", _CORE_FILE)
