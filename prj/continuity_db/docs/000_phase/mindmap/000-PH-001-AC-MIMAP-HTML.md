...
- CREQ/SREQ/AC support files are not treated as standalone MIMAP cross-link targets.
...
- All-MIMAP mode excludes CREQ/SREQ/AC files whose names contain `MIMAP`.
...
8. **All regenerated** – `--all-mimaps` refreshes all standalone MIMAP HTML files and excludes CREQ/SREQ/AC support files.
...
- `000-PH-001-CREQ-MIMAP-HTML.md`
- `000-PH-001-SREQ-MIMAP-HTML.md`
- `000-PH-001.001-SREQ-docs-to-out-path-preservation.md`
- `000-PH-001.002-SREQ-morphology-link-ordering.md`
- `000-PH-001.003-SREQ-MIMAP-cross-links.md`
- `000-PH-001.004-SREQ-all-MIMAP-regeneration.md`
