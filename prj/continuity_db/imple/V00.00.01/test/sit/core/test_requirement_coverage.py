...
REQUIREMENT_SPECS = [
    ...
    ("CDB-09", [("count", "select count(*) from v_canonical_items where item_kind='tool_guide'", 1)]),
    ("CDB-09.1", [("route", "self_check"), ("count", "select count(*) from v_canonical_items where item_kind='tool_guide'", 1)]),
