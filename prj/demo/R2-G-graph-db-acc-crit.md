...
## Verification ideas
- The demo project includes a SQLite-backed graph storage design.
...
- Edges store or reference a graph ID and do not cross graph boundaries.
- Missing or invalid graph IDs produce a warning.
- A reviewer can confirm graph membership is unambiguous for both nodes and edges.
