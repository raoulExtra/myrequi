...
Define a dedicated Synchronisation component that keeps the database, memory, glossary, concepts, routes, and project-related filesystem representations aligned.
...
- Compare canonical database records with project files and report drift or conflicts.
...
- `../../../../continuity_db/docs/000_phase/core/sync/000-PH-001-CREQ-COMPON-synchronisation.md`
