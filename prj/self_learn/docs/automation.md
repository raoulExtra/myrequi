...
- `imple/V00.00.01/self_learn_automation_core.py`
  ...
  - `refresh`: sync, regenerate the docs, write `docs/meta-trace.json`, `docs/meta-optimization.md`, `docs/meta-actions.json`, `docs/meta-actions.md`, and update `continuity.db`
