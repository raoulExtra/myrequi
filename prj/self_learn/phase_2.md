...
- phase_2.md: use phase 0 and phase 1 history to define the current automation mission. | have AI suggest the first concrete automation learning path from prior phase evidence. | a ranked automation mission that becomes the current durable plan.
