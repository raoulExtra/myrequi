#!/usr/bin/env python3
"""Compatibility wrapper for prj/continuity_db/imple/V00.00.01/core/pi_session.py."""
...
_CORE_FILE = _CORE_DIR / "pi_session.py"
if str(_CORE_DIR) not in sys.path:
    sys.path.insert(0, str(_CORE_DIR))
_spec = importlib.util.spec_from_file_location("_continuity_core_pi_session", _CORE_FILE)
